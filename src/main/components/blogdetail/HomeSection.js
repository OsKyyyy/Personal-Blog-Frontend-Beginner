            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-8">
                        ...
                        <p>
                            <Image src={img3Image} alt="" className="img-fluid"/>
                        </p>
                        <p>
                        ...
                        <p>
                            Temporibus ad error suscipit exercitationem hic molestiae totam obcaecati rerum, eius aut,
                        ...
                        <p>
                            <img src="../../../assets/main/images/image_2.jpg" alt="" className="img-fluid"/>
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            aperiam non magni. Reprehenderit nobis odit inventore, quia laboriosam harum excepturi
                            ea.
                        </p>
                        <p>
